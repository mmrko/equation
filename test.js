...
var eq7 = equationParser.parseEquation.bind(equationParser, 'abs(-1)');
var eq8 = equationParser.parseEquation('*1+2-');
...
try {
  ...
  assert.doesNotThrow(eq7, Error, 'should handle unary operands');
  // @todo Implement support for handling leading/trailing operands
  assert.equal(eq8.compute(), 3, 'should handle leading/trailing operands');
  console.log('OK!');
} catch (e) {
